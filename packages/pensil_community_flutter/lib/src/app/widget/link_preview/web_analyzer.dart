...
class WebAnalyzer {
  ...
  static Future<InfoBase?> _getInfo(String url, bool multimedia) async {
    ...
    final Uri? redirectUrl = response.request!.url;
    if (redirectUrl != null) {
  ...
  static String? _getMetaContent(
    ...
    if (meta != null && meta.isNotEmpty) {
      if (meta.any((e) => e.attributes[property] == propertyValue)) {
        final html.Element? ele =
  ...
  static String? _analyzeIcon(Document document, Uri uri) {
    ...
    String? icon = "";
    // get icon first
    html.Element? metaIcon = meta.firstWhereOrNull((e) {
